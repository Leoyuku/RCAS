        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden', background: C.bgBase }}>
            ...
            {showManualBanner && runtime?.onAirPartId && (
                <div
                    ...
                    style={{
                        ...
                        borderBottom: '1px solid rgba(138,106,0,0.3)',
                        cursor: 'pointer', fontFamily: C.mono, fontSize: 9,
                        fontWeight: 700, letterSpacing: '0.1em',
                        color: '#e0b830', flexShrink: 0,
                    }}
                >
                    ⚓ 手动模式 — 点击恢复自动跟随
                </div>
            ...
            >
                {rows.length === 0 ? <EmptyState /> : rows.map((row, idx) => {
                    ...
                    const previewSegIdx = rows.findIndex(r =>
                        r.parts.some(p => (p._id as string) === runtime?.previewPartId)
                    )
                        ...
                        <div style={{
                            ...
                            <div style={{ flex: 1, minHeight: 0, padding: '4px 8px', overflow: 'hidden' }}>
                                <div style={{
                                    ...
                                    maxHeight: '4.05em', overflow: 'hidden', wordBreak: 'break-all',
                                }}>
                            ...
                            <div style={{
                                ...
                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                background: ts.color,
                                fontFamily: C.mono, fontSize: 22, fontWeight: 800,
...
function EmptyState() {
    return (
        <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            height: 200, fontFamily: C.mono, fontSize: 11, color: C.textDim,
